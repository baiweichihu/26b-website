-- 006_reject_rpc_hardening.sql
-- Hotfix: prevent reject RPC from failing with 409 due to legacy profile FK conflicts
-- and avoid accidental deletion of privileged accounts.
