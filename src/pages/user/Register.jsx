...
const Register = () => {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      const heroItems = Array.from(heroRef.current?.querySelectorAll('[data-animate="hero"]') || []);
      const formItems = Array.from(formRef.current?.querySelectorAll('[data-animate="form"]') || []);
